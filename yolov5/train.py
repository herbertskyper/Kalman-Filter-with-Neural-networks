...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='./models/yolov5s_qrcode.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='./data/qrcode.yaml', help='dataset.yaml path')
